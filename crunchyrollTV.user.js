// ==UserScript==
// @name         Crunchyroll TV
// @namespace    http://xixs.com/
// @version      2025-06-02
// @description  Cursor key navigation of Crunchyroll site.
// @author       Qwyzz
...
//        if(e) { e.classList.add("TVHAX-hide") }
        ...
        let es=Array.from(document.getElementsByTagName("a")).concat( Array.from(document.getElementsByTagName("button")) ).concat( Array.from(document.getElementsByTagName("div")) )
